 ...
 */
public class ArgumentPairReader
        extends ResourceCollectionReaderBase
{
    protected Queue<String> currentLines = new ArrayDeque<String>();
            ...
            throws IOException, CollectionException
    {
        try {
            ...
            String label = split[1+skip].trim();
            ...
            String name = currentFileName + "_" + id + "_" + label;
            ...
            throws IOException
    {
        ...
        System.out.println(res.getResource().getFile().getName());
